...
const SnapchatIcon = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5"><path d="M12.206.793c.99 0 4.347.276 5.93 3.821.529 1.193.403 3.219.299 4.847l-.003.06c-.012.18-.022.345-.03.51.075.045.203.09.401.09.3-.016.659-.12.979-.346.164-.12.348-.18.539-.18.212 0 .42.075.585.225.42.39.39.99-.045 1.62-.27.39-.69.62-1.17.765-.27.09-.54.135-.84.18-.09.015-.195.03-.3.06-.135.03-.21.075-.255.12-.075.09-.09.225-.009.39l.009.015c.36.795.93 1.665 1.71 2.295.465.365 1.05.63 1.665.795.435.12.57.375.495.675-.165.615-1.245.93-1.59 1.01-.09.024-.15.037-.19.052l-.01.013c-.09.135-.075.33-.06.511.021.12.032.24.032.36 0 .27-.105.48-.315.615-.24.15-.54.21-.87.21-.51 0-.92-.165-1.35-.345-.24-.12-.48-.21-.735-.27-.135-.03-.27-.045-.405-.045-.39 0-.63.15-.84.315-.39.3-.75.69-1.395 1.02-.75.39-1.635.585-2.67.585-1.035 0-1.92-.195-2.67-.585-.645-.33-1.005-.72-1.395-1.02-.21-.165-.45-.315-.84-.315-.135 0-.27.015-.405.045-.255.06-.48.15-.735.27-.42.18-.84.345-1.35.345-.33 0-.63-.06-.87-.21-.21-.135-.315-.345-.315-.615 0-.12.015-.24.03-.36.015-.18.03-.375-.06-.51l-.005-.016c-.04-.015-.1-.027-.19-.05-.345-.075-1.425-.39-1.59-1.005-.075-.3.06-.555.495-.675.615-.165 1.2-.42 1.665-.795.78-.63 1.35-1.5 1.71-2.295l.009-.015c.075-.165.06-.3-.009-.39-.045-.045-.12-.09-.255-.12-.105-.03-.21-.045-.3-.06-.3-.045-.57-.09-.84-.18-.479-.14-.899-.374-1.17-.764-.435-.63-.465-1.23-.045-1.62.165-.15.372-.225.585-.225.19 0 .375.06.539.18.33.225.69.345.989.345.185 0 .31-.045.39-.09l-.008-.18c-.005-.15-.016-.33-.03-.525-.105-1.62-.225-3.645.297-4.84C7.862 1.077 11.215.793 12.207.793z"/></svg>
);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12 mb-16 md:mb-32">
          ...
          <div className="text-start">
            ...
            <div className="relative w-full h-48 rounded-2xl overflow-hidden border border-slate-100 shadow-sm bg-slate-50 group">
              {finalMapUrl ? (
                <>
                  <iframe
                    src={finalMapUrl}
                  ...
                  {/* Floating Link Button - Clean & Functional */}
                  <a 
                    href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(contactInfo?.addressAr || "شركة مسارات الإبداع الرائدة")}`}
                    target="_blank"
                    rel="noreferrer"
                    className="absolute top-3 end-3 bg-white/90 backdrop-blur-sm p-2 rounded-lg shadow-lg flex items-center gap-2 border border-slate-100 hover:bg-[#00AEEF] hover:text-white transition-all duration-300 opacity-0 group-hover:opacity-100 transform translate-y-[-10px] group-hover:translate-y-0"
                  >
                    <MapPin className="w-3.5 h-3.5" />
                    <span className="text-[10px] font-bold">{locale === "ar" ? "خرائط جوجل" : "Google Maps"}</span>
                  </a>
                </>
              ) : (
